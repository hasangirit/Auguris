...
/**
 * Provide a route using {@link com.mapbox.services.android.navigation.ui.v5.route.NavigationMapRoute#addRoute(DirectionsRoute)} and a route will be drawn using runtime
 ...
 * the route from the map, use {@link com.mapbox.services.android.navigation.ui.v5.route.NavigationMapRoute#removeRoute()}.
 * <p>
...
public class NavigationMapRoute implements ProgressChangeListener, MapView.OnMapChangedListener {
    ...
    /**
     * Construct an instance of {@link com.mapbox.services.android.navigation.ui.v5.route.NavigationMapRoute}.
     *
    ...
    /**
     * Toggle whether or not the route lines visible or not, used in {@link com.mapbox.services.android.navigation.ui.v5.route.NavigationMapRoute#addRoute(DirectionsRoute)}
     * and {@link com.mapbox.services.android.navigation.ui.v5.route.NavigationMapRoute#removeRoute()}.
     *
    ...
    private void setLayerVisibility(boolean visible) {
        ...
        for (Layer layer : layers) {
            ...
            if (layerIds.contains(layer.getId())) {
                if (id.equals(com.mapbox.services.android.navigation.ui.v5.route.NavigationMapRoute.NavigationMapLayers.NAVIGATION_ROUTE_LAYER)
                        || id.equals(com.mapbox.services.android.navigation.ui.v5.route.NavigationMapRoute.NavigationMapLayers.NAVIGATION_ROUTE_SHIELD_LAYER)) {
    ...
    private void addSource(@Nullable DirectionsRoute route) {
        ...
        GeoJsonSource source = mapboxMap.getSourceAs(com.mapbox.services.android.navigation.ui.v5.route.NavigationMapRoute.NavigationMapSources.NAVIGATION_ROUTE_SOURCE);
        if (source == null) {
            GeoJsonSource routeSource = new GeoJsonSource(com.mapbox.services.android.navigation.ui.v5.route.NavigationMapRoute.NavigationMapSources.NAVIGATION_ROUTE_SOURCE, routeLineFeature);
    ...
    private void addNavigationRouteLayer(float scale) {
        Layer routeLayer = new LineLayer(com.mapbox.services.android.navigation.ui.v5.route.NavigationMapRoute.NavigationMapLayers.NAVIGATION_ROUTE_LAYER,
                com.mapbox.services.android.navigation.ui.v5.route.NavigationMapRoute.NavigationMapSources.NAVIGATION_ROUTE_SOURCE).withProperties(
    ...
    private void addNavigationRouteShieldLayer(@ColorInt int routeShieldColor, float scale) {
        Layer routeLayer = new LineLayer(com.mapbox.services.android.navigation.ui.v5.route.NavigationMapRoute.NavigationMapLayers.NAVIGATION_ROUTE_SHIELD_LAYER,
                com.mapbox.services.android.navigation.ui.v5.route.NavigationMapRoute.NavigationMapSources.NAVIGATION_ROUTE_SOURCE).withProperties(
        ...
        addLayerToMap(routeLayer, com.mapbox.services.android.navigation.ui.v5.route.NavigationMapRoute.NavigationMapLayers.NAVIGATION_ROUTE_LAYER);
    }
