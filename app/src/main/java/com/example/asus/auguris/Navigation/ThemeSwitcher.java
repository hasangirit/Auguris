...
/**
 * This class is used to switch theme colors in {@link com.mapbox.services.android.navigation.ui.v5.NavigationView}.
 */
public class ThemeSwitcher {
     ...
     *
     * @param activity {@link com.mapbox.services.android.navigation.ui.v5.NavigationView} where the theme will be set
     */
    static void setTheme(Activity activity) {
        ...
        editor.putBoolean(activity.getString(com.mapbox.services.android.navigation.ui.v5.R.string.dark_theme_enabled), darkThemeEnabled);
        editor.apply();
        activity.setTheme(darkThemeEnabled ? com.mapbox.services.android.navigation.ui.v5.R.style.NavigationViewDark : com.mapbox.services.android.navigation.ui.v5.R.style.NavigationViewLight);
    }
